...
- run id: `router_contract_repair_probe_v0.1c_20260630T143244Z`
- created at: `2026-06-30T14:32:45Z`
- source data: `/Users/lucine/Documents/Job/projects/postTrain/training-corpus/runs/overnight-20260629-v0.6-ai-expanded/curated/kiwi-brain-ai-expanded-v0.1/repairs/router_contract_repair_v0.1c/repaired_datasets`

## Results

| Dataset | Target | Train | Dev | Test | Test acc | Test macro F1 | Majority acc |
| --- | --- | ---: | ---: | ---: | ---: | ---: | ---: |
| router_classifier | route_label | 7047 | 1410 | 1422 | 0.9965 | 0.9974 | 0.1702 |
