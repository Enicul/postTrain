...
- created at: `2026-06-30T05:15:18Z`
- source data: `/Users/lucine/Documents/Job/projects/postTrain/training-corpus/runs/x-bookmarks-recent-111-20260629/curated/golden_v0.1/repairs/citation_verifier_repair_v0.1/repaired_datasets`

## Results

| Dataset | Target | Train | Dev | Test | Test acc | Test macro F1 | Majority acc |
| --- | --- | ---: | ---: | ---: | ---: | ---: | ---: |
| citation_verifier_url | support_type | 108 | 27 | 31 | 0.2581 | 0.139 | 0.4839 |
| citation_support_binary | support_binary | 108 | 27 | 31 | 0.3871 | 0.3767 | 0.5806 |
